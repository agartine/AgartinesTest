#!/usr/bin/expect -f
#
# This Expect script was generated by autoexpect on Fri Jul  1 18:24:03 2016
...
set trustStorePassword [lindex $argv 0]
...
expect -exact "/etc/pki/java/cacerts\r
Password for TrustStore:"
send -- "$trustStorePassword\r"
expect -exact "\r
Re-enter password: "
send -- "$trustStorePassword\r"
expect eof
